  ...
  .controller('tablaUsuarios', ['$scope',
    function($scope) {
      ...
      $scope.usuarios = [{
        ...
        id: 16,
        primernombre: 'Jorge',
        segundonombre: 'Mariano',
        primerapellido: 'Adelantado',
        segundoapellido: 'Villela',
        fechanacimiento: '04-05-1991'
      }, {
        id: 17,
        primernombre: 'Ignacio',
        segundonombre: 'Carlos',
        primerapellido: 'López',
        segundoapellido: 'Lara',
        fechanacimiento: '22-05-1993'
      }, {
        id: 18,
        primernombre: 'Melvin',
        segundonombre: 'Orlando',
        primerapellido: 'Vargas',
        segundoapellido: 'Lago',
        fechanacimiento: '29-04-1987'
      }, {
        id: 19,
        primernombre: 'Milton',
        segundonombre: 'Marlon',
        primerapellido: 'Quinto',
        segundoapellido: 'Perdomo',
        fechanacimiento: '27-03-1985'
      }, {
        id: 20,
        primernombre: 'Javier',
